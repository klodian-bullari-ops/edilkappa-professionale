...
function createQuoteAgent({ instructions, modelChoice, useWeb = false }) {
  ...
  return new Agent({
    ...
    instructions: [
      ...
      "Scrivi un preventivo compatto e senza ripetizioni: sintesi di 2-4 frasi, normalmente 5-10 righe economiche, valutazione tecnica fino a 6 punti, 5-9 fasi operative e 4-8 gruppi di materiali, salvo reale necessità documentale.",
      "Non impostare quote.readyToSave=true se mancano misure decisive. Indica ogni dato mancante in quote.missingInformation come domanda diretta e specifica, chiarendo esattamente cosa deve misurare, fotografare o scegliere il titolare. Per una cucina chiedi, quando pertinenti, dimensioni del locale e della parete utile, posizione di porte/finestre/termosifoni, distanza e quota dello scarico, misure dei moduli, potenza elettrica in kW e foto del quadro, scelta gas/induzione e foto dell'etichetta di eventuali apparecchi murali. Se una misura non è disponibile, chiedi se autorizza una stima a corpo da verificare in sopralluogo; sono ammesse ipotesi a corpo soltanto se dichiarate chiaramente e accettate dall'utente.",
      "Usa intervalli numerici con il trattino ASCII, per esempio 8-12 giorni, e ricontrolla che gli estremi non siano concatenati in valori come 812 o 710.",
      "Non presentare come nuova cucina il semplice trasferimento della cucina esistente. Se il gas è presente e proponi la chiusura delle utenze, indica separatamente se la chiusura o messa in sicurezza del punto gas è compresa da impresa abilitata oppure esclusa.",
      "Le didascalie e le evidenze fotografiche devono descrivere soltanto elementi visibili nella singola immagine. Pagamenti, IVA, misure dichiarate e altre indicazioni del cliente non sono osservazioni fotografiche.",
      "Rispetta l'origine dichiarata delle immagini: quando risultano acquisite da EdilKappa durante il sopralluogo, non definirle fotografie ricevute o fornite dal cliente; se l'origine è da confermare, non attribuirla.",
      "Nei campi destinati al cliente non inserire AI, intelligenza artificiale, OpenAI, ChatGPT, GPT, modelli, algoritmi o riferimenti alla generazione automatica. Presenta il documento esclusivamente come lavoro professionale EdilKappa e usa 'bozza preliminare', mai 'bozza parametrica'. La tracciabilità tecnica resta interna al gestionale.",
...
function buildQuoteReviewerInstructions(instructions) {
  return [
    ...
    "Verifica almeno: somme, sconti e IVA; durata e intervalli numerici (per esempio 710 o 812 al posto di 7-10 o 8-12 sono errori bloccanti); coerenza fra titolo, opere promesse, voci, opere comprese ed esclusioni; una sola alternativa raccomandata e assenza di contraddizioni fra gas e induzione; distinzione fra nuova cucina e trasferimento della cucina esistente; perimetro esplicito della chiusura del punto gas; misure e fattibilità decisive; caldaia, cappa, scarichi e accessi quando pertinenti; chiarezza di fornitura, posa e adattamenti per top, zoccolo, mobili e cappa; Dichiarazione di Conformità (Di.Co.) per modifiche agli impianti; ambiguità nei pagamenti; refusi e testo destinato al cliente.",
    "Controlla che missingInformation contenga vere domande operative: deve essere chiaro che cosa il titolare deve misurare, fotografare o scegliere e deve essere offerta la stima a corpo da verificare in sopralluogo quando la misura non è disponibile.",
    "Non associare a una foto condizioni di pagamento, IVA o dichiarazioni non visibili: le osservazioni fotografiche devono essere abbinate alla fotografia corretta e descrivere soltanto ciò che mostra.",
    "Verifica che i campi destinati al cliente non contengano riferimenti ad AI, intelligenza artificiale, OpenAI, ChatGPT, GPT, modelli, algoritmi, generazione automatica o 'bozza parametrica'. Il documento deve indicare soltanto EdilKappa come autore professionale e deve rispettare l'origine dichiarata delle fotografie.",
