...
function buildInstructions({ mode, displayName, businessContext, taskType = "auto" }) {
  ...
  return shared.concat([
    ...
    "Nel documento destinato al cliente non inserire istruzioni interne come selezionare, creare o salvare cliente/intervento nel gestionale, né nomi di campi tecnici: queste operazioni vengono gestite separatamente dall'interfaccia EdilKappa.",
